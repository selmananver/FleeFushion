    ...
    <div className={`block bg-white py-6 sm:grid sm:grid-cols-5 ${border?"border-b border-gray-300":""}`}>
        ...
        <div className='flex flex-col space-y-4 my-auto justify-self-end'>
            <div className='flex justify-between'>
                <button className={`button sm:p-1 ${disabled ? "opacity-50":""}`} disabled={disabled}>
            ...
            <button className={`button py-2 lg:px-10 md:px-8 px-6 ${disabled ?"opacity-50":""}`} disabled={disabled}>Remove</button>
